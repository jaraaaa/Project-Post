...
Route::post('/contactUs/submit', [PublicController::class, 'submit'])->name('submit');
...
// Rotte gestite dall'admin - grouping
Route::middleware('admin')->group(function(){
    Route::get('/admin/dashboard', [AdminController::class, 'dashboard'])->name('admin.dashboard');
    Route::get('/admin/{user}/setAdmin', [AdminController::class, 'setAdmin'])->name('admin.setAdmin');
    Route::get('/admin/{user}/setRevisor', [AdminController::class, 'setRevisor'])->name('admin.setRevisor');
    Route::get('/admin/{user}/setWriter', [AdminController::class, 'setWriter'])->name('admin.setWriter');
...
// Rotte gestite dal revisor - grouping
...
// Rotte gestite dal writer, incluse creazionee salvataggio articolo - grouping
...
//Rotta per la barra di ricerca degli articoli
